...
const PhoneInputMaterial = ({ 
  ...
  return (
    <div className={`space-y-3 ${className}`}>
      {/* Label flotante - Estilo Material */}
      <div className="relative">
        <Label 
          htmlFor="phone-input" 
          className={`absolute left-4 transition-all duration-200 pointer-events-none ${
            isFocused || phoneNumber || isOpen
      ...
      <div className="relative">
        ...
        <div className={`relative flex items-center bg-white border-2 rounded-lg transition-all duration-200 ${
          ...
          {/* Selector de país - Estilo Material */}
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              onBlur={handleBlur}
              disabled={disabled}
              className="flex items-center gap-2 px-4 py-3 border-r border-gray-300 hover:bg-gray-50 transition-colors rounded-l-lg"
            >
            ...
            {/* Dropdown de países - Estilo Material */}
            {isOpen && (
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              required={required}
              disabled={disabled}
              className="w-full pl-10 pr-4 py-3 border-0 focus:outline-none text-gray-900 placeholder-gray-400 rounded-r-lg"
            />
          </div>
        </div>

        {/* Preview del número completo - Estilo Material */}
        {phoneNumber && (
...
export default PhoneInputMaterial;
