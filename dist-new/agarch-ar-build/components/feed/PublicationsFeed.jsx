    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        {mixedFeed.map((item, index) => {
          const templateData = item.template_id ? getTemplateById(item.template_id) : null;
          const templateTextColor =
            item.text_color || templateData?.defaultTextColor || '#f5f5f5';
                  ...
                  >
                    {item.image_url ? (
                      ...
                      <div
                        ...
                        style={{ background: templateData.background, color: templateTextColor }}
                      >
                        <p className="text-lg font-semibold whitespace-pre-wrap break-words">
                          {item.text || 'Publicación de texto'}
                        </p>
                      </div>
                    ) : (
                      <div className="w-full h-full flex items-center justify-center bg-slate-800/60 text-white p-4 text-center">
                        <p className="text-base font-medium whitespace-pre-wrap break-words line-clamp-6">
