-- SCRIPT MASIVO PARA LIMPIAR TODAS LAS POLÍTICAS RLS REDUNDANTES
-- Ejecutar en el Editor SQL de Supabase
-- Este script resolverá los 33 problemas de seguridad de una vez
...
-- 2. ELIMINAR TODAS LAS POLÍTICAS REDUNDANTES (nombres en español e inglés)
-- Likes
...
-- 3. CREAR POLÍTICAS OPTIMIZADAS PARA CADA TABLA
